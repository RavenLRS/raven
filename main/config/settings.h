...
#endif
#define SETTING_COUNT (SETTING_STATIC_COUNT + SETTING_TX_FOLDER_COUNT + SETTING_RX_FOLDER_COUNT + SETTING_TX_RECEIVERS_COUNT + SETTING_PWM_COUNT + SETTING_SCREEN_FOLDER_COUNT)
