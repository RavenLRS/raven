...
LIBPATHS := ./lib/libopencm3 ./libopencm3 ../../../../libopencm3 ../../../../../libopencm3
...
$(BUILDDIR)/%.o: %.c
	@printf "  CC      $(*).c\n"
	$(Q)mkdir -p $(dir $@)
	$(Q)$(CC) $(TGT_CFLAGS) $(CFLAGS) $(TGT_CPPFLAGS) $(CPPFLAGS) -o $(BUILDDIR)/$(*).o -c $(*).c

$(BUILDDIR)/%.o: %.cxx
	@printf "  CXX     $(*).cxx\n"
	$(Q)mkdir -p $(dir $@)
	$(Q)$(CXX) $(TGT_CXXFLAGS) $(CXXFLAGS) $(TGT_CPPFLAGS) $(CPPFLAGS) -o $(BUILDDIR)/$(*).o -c $(*).cxx

$(BUILDDIR)/%.o: %.cpp
	@printf "  CXX     $(*).cpp\n"
	$(Q)mkdir -p $(dir $@)
	$(Q)$(CXX) $(TGT_CXXFLAGS) $(CXXFLAGS) $(TGT_CPPFLAGS) $(CPPFLAGS) -o $(BUILDDIR)/$(*).o -c $(*).cpp
